 ...
 * @author Deividas Kirsonis
 * */
public class EarthquakeCityMap extends PApplet {
	
	// Member variables to store the data that the setup and 
	// draw methods will need to access(as well as other methods).
	...
	{
		//if a marker is already selected
		if (lastSelected != null) {
			return;
		}
		...
		{
			Marker marker = m;
			//if marker at the location of the mouse cursor
